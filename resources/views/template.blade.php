...
<body class="homepage">
      ...
      <div class="row justify-content-between align-items-center w-100">
        ...
        <div class="col-auto">
          <a class="navbar-brand text-white" href="/">
            ...
            <img src="images/moler_logo.jpg" alt="logo" class="logo-img">
          </a>
        </div>
  ...
  <section id="billboard" class="bg-light py-2">
    <div class="container">
      <div class="row justify-content-center">
        <h1 class="section-title text-center" data-aos="fade-up">Ponuda Meseca</h1>
        <div class="col-md-6 text-center" data-aos="fade-up" data-aos-delay="300">
          <p>Svakog meseca izdvajamo najbolje ponude molerskih usluga koje mozete da nadjete na tržištu. Ovog meseca predstavljamo:</p>
        </div>
      </div>
      <div class="row">
          ...
          <div class="swiper-wrapper d-flex border-animation-left">
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                <div class="image-holder">
                  <a href="#">
                    <img src="images/krecenje.jpg" alt="product" class="img-fluid" href="/opsirnije/1">
                  </a>
                </div>
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
                    <a href="/opsirnije/1" class="item-anchor">Krecenje</a>
                  </h5>
                  <p>Naša ekipa majstora garantuje vrhunsko krečenje koje osvežava vaš prostor.</p>
                  <div class="btn-left">
                    <a href="/opsirnije/1" class="btn-link fs-6 text-uppercase item-anchor text-decoration-none">Opsirnije</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                <div class="image-holder">
                  <a href="#">
                    <img src="images/farbanje_radijatora.webp" alt="product" class="img-fluid">
                  </a>
                </div>
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
                    <a href="/opsirnije/4" class="item-anchor">Farbanje Radijatora</a>
                  </h5>
                  <p>Naša molerska firma specijalizovana je za farbanje radijatora, pružajući vrhunski kvalitet.</p>
                  <div class="btn-left">
                    <a href="/opsirnije/4" class="btn-link fs-6 text-uppercase item-anchor text-decoration-none">Opsirnije</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                <div class="image-holder">
                  <a href="#">
                    <img src="images/gletovanje.webp" alt="product" class="img-fluid">
                  </a>
                </div>
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
                    <a href="/opsirnije/2" class="item-anchor">Gletovanje</a>
                  </h5>
                  <p>Za besprekoran izgled zidova neophodno je kvalitetno gletovanje, a mi smo eksperti u tome!</p>
                  <div class="btn-left">
                    <a href="/opsirnije/2" class="btn-link fs-6 text-uppercase item-anchor text-decoration-none">Opsirnije</a>
                  </div>
                </div>
              </div>
            </div>
  ...
  <section class="testimonials py-5 bg-light">
    <div class="section-header text-center mt-5">
      <h3 class="section-title">Komentari nasih klijenata</h3>
    </div>
      ...
      <div class="swiper-wrapper d-flex">
        <div class="swiper-slide">
          <div class="testimonial-item text-center">
            <blockquote>
              <p>“Vrhunski odradjen posao”</p>
              <div class="review-title text-uppercase">Milos M.</div>
            </blockquote>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="testimonial-item text-center">
            <blockquote>
              <p>“Vrlo kvalitetni majstori"</p>
              <div class="review-title text-uppercase">Nikola N.</div>
            </blockquote>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="testimonial-item text-center">
            <blockquote>
              <p>“Majstori su brzi i znaju svoj zanat. Svaka preporuka”</p>
              <div class="review-title text-uppercase">Vuk P.</div>
            </blockquote>
          </div>
        </div>
      </div>
  ...
  <footer id="footer" class="mt-5">
      <div class="container">
        <div class="row text-center">
            <p>© Copyright 2025 Moleraj. All rights reserved.</p>
          </div>
        </div>
      </div>
    </div>
